							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a class="btn btn-sm btn-primary view_forum" href="../index.php?page=view_forum&id=<?php echo $row['id'] ?>" target="_blank" data-id="<?php echo $row['id'] ?>" >View</a>
										<button class="btn btn-sm btn-primary edit_forum" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn btn-sm btn-danger delete_forum" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
